...
# Мультиагентная система разработки v3.9.0
...
- [Установка и Настройка](#-установка-и-настройка-installation--setup)
  - [Копирование папок](#1-скопируйте-папки-фреймворка)
  - [Выбор ассистента](#2-выберите-вашего-ai-ассистента)
- [Обзор Системы](#-обзор-системы-system-overview)
  - [Структура директорий](#структура-директорий)
  - [Агенты и Роли](#-команда-агентов-роли)
...
- [Как начать разработку](#-как-начать-разработку-пошаговый-план)
  - [Phase 0: Product Discovery](#phase-0-product-discovery-опционально)
...
Для использования **Подсистемы выполнения инструментов** (native tools) необходим Python 3.9+ со следующими пакетами:
...
|------------|------------------|-----------------|
| **Cursor IDE** | `00` + роль (01-10) | Вручную или через `AGENTS.md` |
| **Antigravity** | `GEMINI.md` (включает глобальные принципы) | **Автоматически (нативно)**. Ручная конкатенация `00` не требуется. |
