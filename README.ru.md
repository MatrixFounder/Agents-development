...
# Мультиагентная система разработки v3.4.2
...
**[>> Руководство по Оркестратору и Инструментам <<](System/Docs/ORCHESTRATOR.md)** (Конфигурация, Новые инструменты и Устранение неполадок)
...
### 1. Общие требования
Независимо от выбора инструмента, вам нужны **Персоны Агентов** и **Документация** в корне проекта:
- Скопируйте всю папку `/System` в корень вашего проекта.
...
├── System/
│   ├── Agents/                  # [Common] Персоны Агентов (00-10)
