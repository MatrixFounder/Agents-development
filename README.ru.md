...
# Мультиагентная система разработки v3.9.3
...
### 🔑 Мета-Системный Промпт (00_agent_development.md)
Файл `00_agent_development.md` служит **Мета-Системным Промптом** для Cursor.
Он определяет глобальные принципы (Уровни Навыков, Границы Задач) и **ДОЛЖЕН** быть включен в контекст при ручном вызове агентов.
Для Antigravity эта логика обрабатывается нативно через `GEMINI.md`.
