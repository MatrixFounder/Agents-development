...
|----------|------|--------|--------------|
| **Техническое Задание (ТЗ)** | `docs/TZ.md` | **Живой / История** | Оставлять. Перезаписывается для новых задач или архивируется. |
| **Архитектура** | `docs/ARCHITECTURE.md` | **Source of Truth** | **НЕ УДАЛЯТЬ**. Поддерживать в актуальном состоянии. Это карта системы. |
| **Известные проблемы** | `docs/KNOWN_ISSUES.md` | **Живой документ** | Оставлять. Фиксировать баги, воркэраунды и сложные места. |
| **Архив задач** | `docs/tasks/task-ID-name.md` | **История** | **Копия ТЗ**. Сохраняет историю того, что было сделано. |
